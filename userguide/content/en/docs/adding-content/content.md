...
Because most technical documentation sites have different sections for different types of content, the Docsy theme comes with the [following templates](https://github.com/pasabanov/docsy/tree/main/layouts) for top-level site sections that you might need:

* [`docs`](https://github.com/pasabanov/docsy/tree/main/layouts/docs) is for pages in your site's Documentation section.
* [`blog`](https://github.com/pasabanov/docsy/tree/main/layouts/blog) is for pages in your site's Blog.
* [`community`](https://github.com/pasabanov/docsy/tree/main/layouts/community) is for your site's Community page.

It also provides a [default "landing page" type of template](https://github.com/pasabanov/docsy/tree/main/layouts/_default) with the site header and footer, but no left nav, that you can use for any other section. In this site and our example site it's used for the site [home page](/) and the [About](/about/) page.
...
The template you'll probably use most often is the [`docs` template](https://github.com/pasabanov/docsy/blob/main/layouts/docs/baseof.html) (as used in this page) or the very similar [`blog` template](https://github.com/pasabanov/docsy/blob/main/layouts/blog/baseof.html). Both these templates include:
...
Docsy's [default page template](https://github.com/pasabanov/docsy/blob/main/layouts/docs/baseof.html) has no left nav and is useful for creating a home page for your site or other "landing" type pages.
